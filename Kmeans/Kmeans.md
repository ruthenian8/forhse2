...
```
    ...
    peak memory: 130.49 MiB, increment: 0.02 MiB
    CPU times: user 107 ms, sys: 13.6 ms, total: 121 ms
    Wall time: 237 ms
...
```
    ...
    peak memory: 130.56 MiB, increment: 0.06 MiB
    CPU times: user 77.2 ms, sys: 19.4 ms, total: 96.7 ms
    Wall time: 222 ms
...
```
    ...
    Test accuracy equals: 0.9666666666666667
